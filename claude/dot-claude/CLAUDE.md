# CLAUDE.md - Universal Coding Guidelines for AI Agents
...
- ✅ User: "Add doom_loop_threshold to config" → *searches docs first* → *finds correct option* → *adds correct option*
